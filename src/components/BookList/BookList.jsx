  ...
  return (
      <div className={"panel " + (books.length ? "" : "panel-empty")}>
        ...
        books.map((book, index) => {
          ...
          const thumbnail = book.imageLinks ? (book.imageLinks.thumbnail || noImage) : noImage;
          ...
          return (
            <section key={`${book.id}-${index}`} className={listType}>
              ...
              <div className="media">
                ...
                {/* BOOK DETAILS: render non-linked thumbnail and reading status */
                listType==="book-details" ? (
                  ...
                  /* SEARCH & MY BOOKS: render non-linked thumbnail only */
                    <Link to={link}>
                      <img src={thumbnail} alt="book thumbnail" />
                    </Link>
                )}
                ...
                <div className="media-body ml-3">
                  ...
                  {/* BOOK DETAILS: render non-linked title and include subtitle if it exists */
                  listType==="book-details" ? (
                    <div>
                    ...
                    /* SEARCH & MY BOOKS: render title link only */
                  ...
                  {/* BOOK DETAILS: render the description, date, page count and infolink */
                  listType==="book-details" && (
                    <div>
                  ...
                  {/* BOOK DETAILS & MY BOOKS: render the Change Status Menu */
